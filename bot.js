...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [rin-tohsaka] --*' + 
                                    '\n*rin-tohsaka an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [rin-tohsaka] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
